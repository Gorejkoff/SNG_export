...
if (document.querySelector('.about__certificates-swiper')) {
   const swiper = new Swiper('.about__certificates-swiper', {
      keyboard: {
         enabled: true,
         onlyInViewport: true,
      },
      ...
      slidesPerView: 1,
      navigation: {
         nextEl: '.certificates-arrow-prev',
         prevEl: '.certificates-arrow-next',
      },

   });

   document.addEventListener('click', (event) => {
      if (event.target.closest('.about__certificates-size')) {
         let number = event.target.closest('.about__certificates-size').dataset.number_slide;
         number && swiper.slideToLoop(number)
      }
   })
}

if (document.querySelector('.about__thanks-swiper')) {
   const swiper = new Swiper('.about__thanks-swiper', {
      keyboard: {
         enabled: true,
         onlyInViewport: true,
      },
      ...
      slidesPerView: 1,
      navigation: {
         nextEl: '.thanks-arrow-prev',
         prevEl: '.thanks-arrow-next',
      },
      breakpoints: {
         768: {
            slidesPerView: 2
...
if (document.querySelector('.project-swiper__swiper')) {
   const swiper = new Swiper('.project-swiper__swiper', {
      ...
      slidesPerView: 1,
      navigation: {
         nextEl: '.project-swiper__button-prev',
         prevEl: '.project-swiper__button-next',
      },
   });
   swiper.autoplay.stop();
   const buttons = document.querySelector('.project-swiper__buttons');
   const scale_increase = document.querySelector('.project-swiper__increase');
   const scale_reduce = document.querySelector('.project-swiper__reduce');
   const play = document.querySelector('.project-swiper__play');
   activeButtons();
   buttons.addEventListener('click', (event) => {
      if (event.target.closest('.project-swiper__increase')) {
         swiper.zoom.in(swiper.zoom.scale + 1);
         activeButtons();
      }
      if (event.target.closest('.project-swiper__reduce')) {
         swiper.zoom.in(swiper.zoom.scale - 1);
         activeButtons();
      }
      if (event.target.closest('.project-swiper__play')) {
         playSwiper()
      }
   })
   ...
   function playSwiper() {
      if (swiper.autoplay.running == false) {
         ...
         play.classList.add('swiper-play');
         return;
      }
      swiper.autoplay.stop();
      play.classList.remove('swiper-play');
   }

   function activeButtons() {
      if (swiper.zoom.scale > 1) {
         scale_reduce.removeAttribute('disabled');
      }
      if (swiper.zoom.scale < 4) {
         scale_increase.removeAttribute('disabled');
      }
      if (swiper.zoom.scale <= 1) {
         scale_reduce.setAttribute('disabled', 'true');
      }
      if (swiper.zoom.scale >= 4) {
         scale_increase.setAttribute('disabled', 'true');
      }
   }
...
if (document.querySelector('.product-card__swiper')) {
   ...
   const swiper = new Swiper('.product-card__swiper-thamb', {
      keyboard: {
         enabled: true,
         onlyInViewport: true,
      },
      ...
      slidesPerView: 4,
      navigation: {
         nextEl: '.product-card__prev',
         prevEl: '.product-card__next',
      },
   });

   const swiper2 = new Swiper('.product-card__swiper', {
      keyboard: {
         enabled: true,
         onlyInViewport: true,
      },
...
const swiper = new Swiper('.product-card__besides-swiper', {
   keyboard: {
      enabled: true,
      onlyInViewport: true,
   },
   ...
   slidesPerView: 1,
   pagination: {
      el: '.product-card__besides-pagination',
      type: 'bullets',
   },
});